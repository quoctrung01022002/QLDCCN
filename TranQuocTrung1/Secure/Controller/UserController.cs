...
using TranQuocTrung1.Secure.Data;
using TranQuocTrung1.Secure.Key;
using TranQuocTrung1.Secure.Models;
using RouteAttribute = Microsoft.AspNetCore.Components.RouteAttribute;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Options;

namespace TranQuocTrung1.Secure.Controller
{
    public class UserController : ControllerBase
    {
        private readonly ROCKERContext context_;
        private readonly AppSetting appSettings_;
        public UserController(ROCKERContext context, IOptionsMonitor<AppSetting> optionsMonitor)
        {
            context_ = context;
        ...
        public async Task<IActionResult> Validate(LoginModels model)
        {
            ...
            try
            {
                var account = context_.Users.SingleOrDefault(p => p.Email == model.Email
        ...
        public async Task<IActionResult> RenewToken(TokenModels tokenModels)
        {
            ...
            try
            {
                ...
                await context_.SaveChangesAsync();
                //create new token
                var user = await context_.Users.SingleOrDefaultAsync(a => a.Username == storedToken.nguoidungUsername);
